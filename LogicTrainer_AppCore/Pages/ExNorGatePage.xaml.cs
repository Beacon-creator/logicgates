...
{
    /// <summary>
    /// Interaction logic for ExNorGatePage.xaml
    /// </summary>
    public partial class ExNorGatePage : Page
    {
        public ExNorGatePage()
        {
            InitializeComponent();
        ...
        private void butExecuteXNor_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                int outputC = (input1 == input2) ? 1 : 0; // calculate XNOR
