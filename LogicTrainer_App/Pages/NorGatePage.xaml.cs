...
{
    /// <summary>
    /// Interaction logic for NorGatePage.xaml
    /// </summary>
    public partial class NorGatePage : Page
    {
        public NorGatePage()
        {
            InitializeComponent();
        ...
        private void butExecuteNor_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
               ...
               int input1 = Convert.ToInt32(tt1.Text, 2);
                ...
                bool input1Bool = (input1 != 0);

                int input2 = Convert.ToInt32(tt2.Text, 2);

                bool input2Bool = (input2 != 0);

                bool output = !(input1Bool || input2Bool);

                int result = (output ? 1 : 0);

                string binaryResult = Convert.ToString(result, 2);

                tt3.Text = binaryResult;

                NorGate newSelect = new NorGate();
