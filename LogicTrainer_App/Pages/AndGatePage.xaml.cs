...
{
    /// <summary>
    /// Interaction logic for AndGatePage.xaml
    /// </summary>
    public partial class AndGatePage : Page
    {
        public AndGatePage()
        {
            InitializeComponent();
        ...
        private void butExecuteAnd_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                    ...
                    int inputA = int.Parse(tt1.Text.ToString());

                    int inputB = int.Parse(tt2.Text.ToString());

                    int outputC = inputA & inputB;

                    tt3.Text = outputC.ToString();
