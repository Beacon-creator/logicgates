...
{
    /// <summary>
    /// Interaction logic for OrGatePage.xaml
    /// </summary>
    public partial class OrGatePage : Page
    {
        public OrGatePage()
        {
            InitializeComponent();
        ...
        private void butExecuteOr_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                //cslculate or gate
                int input1 = Convert.ToInt32(tt1.Text);

                int input2 = Convert.ToInt32(tt2.Text);

                bool inputBool1 = (input1 != 0);

                bool inputBool2 = (input2 != 0);

                bool output = (inputBool1 || inputBool2);
