...
{
    /// <summary>
    /// Interaction logic for ExOrGatePage.xaml
    /// </summary>
    public partial class ExOrGatePage : Page
    {
        public ExOrGatePage()
        {
            InitializeComponent();
        ...
        private void butExecuteAnd_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                int input1 = Convert.ToInt32(tt1.Text, 2);
                int input2 = Convert.ToInt32(tt2.Text, 2);

                // calculate XOR gate result
                int outputC = input1 ^ input2;

                // convert result to binary string representation
                string resultBinary = Convert.ToString(outputC, 2);

                // set Label text to result binary string representation
                tt3.Text = resultBinary;
            ...
            {
                MessageBox.Show("Select Value for imput Switch", "Warning", MessageBoxButton.OK, MessageBoxImage.Warning);
            }

            catch (ArgumentOutOfRangeException)
            {
                MessageBox.Show("Select Values for Switch 1 and Switch 2");
            }
            catch (Exception ex)
            {
